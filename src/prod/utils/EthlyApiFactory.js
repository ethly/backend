 ...
 */
export function deployContract(account: EthereumAddress, httpAddress: string): Promise<EthlyApi> {
 ...
 * @returns {Promise<EthlyApi>} created api
 */
export function createApiForAddress(account: EthereumAddress, httpAddress: string): Promise<EthlyApi> {
